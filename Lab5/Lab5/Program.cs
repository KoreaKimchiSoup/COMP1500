...
namespace Lab5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double[] revenuePerDay = new double[8] { 1.0, 1.50, 5.00, 184.20, 341.25, 104591.25, 246001.00, 246873.00 };
            ...
            revenuePerDay = new double[8] { 1.0, 1.50, 5.00, 200.00, 341.25, 435.44, 246001.00, 22.22 };
